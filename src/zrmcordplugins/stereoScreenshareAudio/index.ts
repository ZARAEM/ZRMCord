...
let orig: { SRD?: Function; SLD?: Function; } = {};
...
const patchSDPDesc = (desc: RTCSessionDescriptionInit | null | undefined) => {
...
export default definePlugin({
    ...
    authors: [{ name: "nerdwave-nick", id: 0n }, { name: "Streets", id: 463495065407586304n }],
    ...
    async stop() {
        ...
        // to their original values which were stored in orig
        if (orig.SRD) RTCPeerConnection.prototype.setRemoteDescription = orig.SRD as any;
        if (orig.SLD) RTCPeerConnection.prototype.setLocalDescription = orig.SLD as any;
        orig = {};
    },
});
